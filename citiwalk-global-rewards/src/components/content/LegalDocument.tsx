      ...
      <Container>
        ...
        <Reveal className="mx-auto mt-12 max-w-4xl">
          <GlassCard className="p-6 sm:p-10">
            <div className="mb-8 rounded-card border border-accent-300/15 bg-accent-400/[0.055] p-5">
              <p className="text-xs font-bold uppercase tracking-[0.15em] text-accent-300">Content status</p>
              <p className="mt-2 text-sm leading-6 text-muted">This route and document system are ready. Final campaign-specific language must be supplied and approved before launch.</p>
            </div>
