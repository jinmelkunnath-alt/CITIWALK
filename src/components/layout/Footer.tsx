...
export function Footer() {
  ...
  const legalLinks = [
    { label: "Terms", href: settings.termsUrl },
    { label: "Privacy", href: settings.privacyUrl },
    { label: "Official Rules", href: settings.officialRulesUrl },
  ];
          ...
          <div className="grid gap-10 lg:grid-cols-[1.35fr_1fr_1fr]">
            ...
            <div>
              ...
              <ul className="mt-5 space-y-3">
                {legalLinks.map((item) => (
                  <li key={item.label}>
                    <a href={item.href} className="inline-flex items-center gap-1.5 text-sm text-muted transition hover:text-white">
                      {item.label}
